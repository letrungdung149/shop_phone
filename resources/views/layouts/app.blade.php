...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/DataTables-1.11.4/css/dataTables.bootstrap4.min.css"/>
    ...
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/Buttons-2.2.2/css/buttons.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/ColReorder-1.5.5/css/colReorder.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/DateTime-1.1.1/css/dataTables.dateTime.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/FixedColumns-4.0.1/css/fixedColumns.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/FixedHeader-3.2.1/css/fixedHeader.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/KeyTable-2.6.4/css/keyTable.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/Responsive-2.2.9/css/responsive.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/RowGroup-1.1.4/css/rowGroup.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/RowReorder-1.2.8/css/rowReorder.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/Scroller-2.0.5/css/scroller.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/SearchBuilder-1.3.0/css/searchBuilder.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/SearchPanes-1.4.0/css/searchPanes.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css" href="/assets/admin/DataTables/Select-1.3.4/css/select.bootstrap4.min.css"/>
    <link rel="stylesheet" type="text/css"
          href="/assets/admin/DataTables/StateRestore-1.1.0/css/stateRestore.bootstrap4.min.css"/>
...
<div class="navbar navbar-expand-lg navbar-dark navbar-static">
    ...
    <div class="navbar-brand text-center text-lg-left">
        <a href="index.html" class="d-inline-block">
            <img src="/assets/admin/img/logo.png" class="d-none d-sm-block" alt="">
        </a>
    </div>
            ...
            <div class="sidebar-section">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item"><a href="{{ route('admin.categories.index') }}" class="nav-link"><i
                                class="icon-folder"></i> <span>Categories</span></a></li>
                    <!-- /main -->
                </ul>
            </div>
            <!-- /main navigation -->
...
<script type="text/javascript"
        src="/assets/admin/DataTables/DataTables-1.11.4/js/dataTables.bootstrap4.min.js"></script>
...
<script type="text/javascript"
        src="/assets/admin/DataTables/FixedColumns-4.0.1/js/dataTables.fixedColumns.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/FixedHeader-3.2.1/js/dataTables.fixedHeader.min.js"></script>
...
<script type="text/javascript"
        src="/assets/admin/DataTables/SearchBuilder-1.3.0/js/dataTables.searchBuilder.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/SearchBuilder-1.3.0/js/searchBuilder.bootstrap4.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/SearchPanes-1.4.0/js/dataTables.searchPanes.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/SearchPanes-1.4.0/js/searchPanes.bootstrap4.min.js"></script>
<script type="text/javascript" src="/assets/admin/DataTables/Select-1.3.4/js/dataTables.select.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/StateRestore-1.1.0/js/dataTables.stateRestore.min.js"></script>
<script type="text/javascript"
        src="/assets/admin/DataTables/StateRestore-1.1.0/js/stateRestore.bootstrap4.min.js"></script>
...
<script src="/assets/admin/DataTables/datatable-assets/editor.jsTree.js"></script>
