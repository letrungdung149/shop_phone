    ...
    <div class="container padd-60">
        <div class="col-md-12 footer-top-sec">
            <div class="col-md-4 col-sm-5 payment">
                <img src="frontend/img/footer/paypal.png" alt="" class="img-responsive" />
                <img src="frontend/img/footer/visa.png" alt="" class="img-responsive" />
                <img src="frontend/img/footer/mastercard.png" alt="" class="img-responsive" />
            </div>
            <div class="col-md-4 col-sm-2 footer-logo"><img src="frontend/img/index/logo.png" alt="" class="img-responsive" /></div>
