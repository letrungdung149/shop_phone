            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="col-sm-5 modal-img">
                        <img src="frontend/img/index/modal-bg.jpg" class="img-responsive" alt="" />
                        <h2>Sign In</h2>
                        <p>Sign up our Website and receive up to $100 coupon for first shopping</p>
                        <div class="modal-img-text"><a href="#"><img src="frontend/img/index/login-logo.png" alt="" class="img-responsive" /></a></div>
                    </div>
